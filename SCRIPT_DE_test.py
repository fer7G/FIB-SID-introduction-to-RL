...
# Crear agente
agent = DirectEstimationAgent(env=env, env_vis=env_vis, gamma=1, theta=1e-5, n_test_episodes_per_iteration=200, T_max=200)

# Recolectar experiencia (estimación directa)
agent.gather_experience(num_episodes=5000)
...
# agent.plot_policy_changes("policy_changes.png")
